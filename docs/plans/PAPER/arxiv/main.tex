...
Generated conceptual artwork is used only for Figure~\ref{fig:overview}; it communicates architecture and contains no measurement or factual comparison. Empirical tables are derived from the checked-in benchmark dataset; raw per-run output remains a requirement for a complete empirical release.
