	...
	defaults := []models.CatalogModel{
		{
			...
			Description:      "Standard coding model for everyday development",
			DescriptionKo:    "일상적인 개발을 위한 표준 코딩 모델",
			Family:           "code",
		...
		},
		{
			...
			Description:      "Advanced model with deeper reasoning for complex tasks",
			DescriptionKo:    "복잡한 작업을 위한 심층 추론 고급 모델",
			Family:           "code",
			ReleaseChannel:   "stable",
			Availability:     "available",
			DefaultRank:      20,
