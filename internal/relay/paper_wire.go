...
// This file is the cross-repo wire contract for the PAPER extension
// messages the relay exchanges with the harness connector
// (`patty-code-pccp/internal/provenancewire` + `internal/paperproto`).
//
...
// ---------------------------------------------------------------------------
// Lease (relay → connector). Mirrors paperproto.Lease field numbers.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Policy epoch (relay → connector). Mirrors paperproto.PolicyEpoch.
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Catalog snapshot (relay → connector). Mirrors paperproto.CatalogSnapshot
...
// Ensure the relay's PAPER stack is linked in this file's dependency
// graph (AuthContext / digest helpers are shared with the listener).
var _ = paper.MarshalCBOR
